        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p><?=substr($_SESSION['nombrecompleto'],0,15)?></p>
...
<!--                <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Warning</span></a></li>-->
                <li><a href="<?=base_url()?>Profile"><i class="fa fa-circle-o text-aqua"></i> <span>Cuenta</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
